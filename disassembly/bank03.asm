...
.gsu
  ...
  JSL rom_to_wram_rt($7E,gsu_init_4)        ; $0394FE |
  SEP #$20                                  ; $039502 |
  RTL                                       ; $039504 |
...
.dont_despawn_next
  ...
  JSL rom_to_wram_rt($7E,gsu_init_4)        ; $039532 |/  via r0 return value
  SEP #$20                                  ; $039536 |
...
check_new_sprites:
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0395C9 | GSU init
  REP #$10                                  ; $0395CD |
...
CODE_0397EC:
  ...
  LDX #$09                                  ; $0397F9 |
  LDA #$884C                                ; $0397FB |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0397FE | GSU init
...
CODE_039802:
  ...
  LDX #$0A                                  ; $03980C |
  LDA #$CFED                                ; $03980E |
  JSL rom_to_wram_rt($7E,gsu_init_4)        ; $039811 | GSU init
  LDA #$0008                                ; $039815 |
...
CODE_039874:
  ...
  LDX #$09                                  ; $03987B |
  LDA #$F83A                                ; $03987D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $039880 | GSU init
...
CODE_039895:
  LDX #$09                                  ; $039895 |
  LDA #$8084                                ; $039897 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03989A | GSU init
  LDA $607A                                 ; $03989E |\
...
CODE_039956:
  ...
  LDX #$09                                  ; $039977 |
  LDA #$907C                                ; $039979 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03997C | GSU init
  LDA !gsu_r1                               ; $039980 |
...
CODE_039BC7:
  ...
  LDX #$0A                                  ; $039BF3 |
  LDA #$CE2F                                ; $039BF5 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $039BF8 | GSU init
  PLY                                       ; $039BFC |
  LDX $12                                   ; $039BFD |
  LDA !gsu_r7                               ; $039BFF |
  AND #$0006                                ; $039C02 |
...
despawn_sprite:
  ...
  BRA return_03A34B                         ; $03A2F6 | else return
...
.threshold_B
  ...
  CMP #$0160                                ; $03A30B |/
  BCC return_03A34B                         ; $03A30E | else return
...
.camera_event
  ...
  BNE return_03A34B                         ; $03A31C |/ don't despawn
...
CODE_03AFBC:
  ...
  LDX #$08                                  ; $03AFE5 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03AFE7 | gsu code: DATA_08xxxx:         (table value)
...
CODE_03B078:
  JSL CODE_03AF0D                           ; $03B078 | entry point
  TXY                                       ; $03B07C |
...
CODE_03B249:
  ...
  TYX                                       ; $03B24A |
CODE_03B24B:
  JSL CODE_04906C                           ; $03B24B | entry point
...
CODE_03B7CD:
  LDX #$0B                                  ; $03B7CD |
  LDA #$C6B7                                ; $03B7CF |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03B7D2 | GSU init
  LDA #$0010                                ; $03B7D6 |
...
CODE_03BBE4:
  ...
  LDX #$0B                                  ; $03BC03 |
  LDA #$BCF8                                ; $03BC05 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03BC08 | GSU init
  LDX $12                                   ; $03BC0C |
  LDA !gsu_r0                               ; $03BC0E |
...
CODE_03BC92:
  ...
  LDX #$09                                  ; $03BCB0 |
  LDA #$907C                                ; $03BCB2 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03BCB5 | GSU init
  LDX $12                                   ; $03BCB9 |
...
CODE_03BCD9:
  ...
  LDX #$09                                  ; $03BCF7 |
  LDA #$907C                                ; $03BCF9 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03BCFC | GSU init
  LDX $12                                   ; $03BD00 |
  LDA !gsu_r1                               ; $03BD02 |
...
CODE_03BE6A:
  ...
  LDX #$0B                                  ; $03BE83 |
  LDA #$86B6                                ; $03BE85 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03BE88 | GSU init
  LDX $12                                   ; $03BE8C |
  ...
  LDX #$0B                                  ; $03BE9E |
  LDA #$86B6                                ; $03BEA0 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03BEA3 | GSU init
  LDX $12                                   ; $03BEA7 |
...
CODE_03C236:
  ...
  LDX #$0A                                  ; $03C24E |
  LDA #$CE2F                                ; $03C250 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03C253 | GSU init
  LDX $12                                   ; $03C257 |
  LDA !gsu_r7                               ; $03C259 |
  AND #$0002                                ; $03C25C |
...
CODE_03C3DF:
  ...
  LDX #$0A                                  ; $03C40B |
  LDA #$CE2F                                ; $03C40D |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03C410 | GSU init
  LDX $12                                   ; $03C414 |
  LDA !gsu_r6                               ; $03C416 |
  CMP $1DAE                                 ; $03C419 |
...
CODE_03C4B9:
  ...
  LDX #$08                                  ; $03C4E2 |
  LDA #$82F8                                ; $03C4E4 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03C4E7 | GSU init
  INC $0CF9                                 ; $03C4EB |
  LDX $12                                   ; $03C4EE |
  RTL                                       ; $03C4F0 |
...
CODE_03C57D:
  ...
  LDX #$08                                  ; $03C5D6 |
  LDA #$8619                                ; $03C5D8 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03C5DB | GSU init
  INC $0CF9                                 ; $03C5DF |
  LDX $12                                   ; $03C5E2 |
  RTL                                       ; $03C5E4 |
...
CODE_03C9F1:
  ...
  LDX #$08                                  ; $03CA20 |
  LDA #$BC98                                ; $03CA22 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03CA25 | GSU init
  REP #$10                                  ; $03CA29 |
  LDA #$7FFF                                ; $03CA2B |
  STA $703070                               ; $03CA2E |
  LDX #$001C                                ; $03CA32 |
...
CODE_03CB92:
  ...
  LDX #$0A                                  ; $03CB9E |
  LDA #$CE2F                                ; $03CBA0 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03CBA3 | GSU init
  LDX $12                                   ; $03CBA7 |
  ...
  LDX #$0A                                  ; $03CBBD |
  LDA #$CE2F                                ; $03CBBF |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03CBC2 | GSU init
  LDX $12                                   ; $03CBC6 |
...
CODE_03CD91:
  ...
  LDX #$0A                                  ; $03CD9D |
  LDA #$CE2F                                ; $03CD9F |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03CDA2 | GSU init
  LDX $12                                   ; $03CDA6 |
...
CODE_03CFDF:
  ...
  LDX #$09                                  ; $03CFE3 |
  LDA #$98B6                                ; $03CFE5 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03CFE8 | GSU init
  LDX $12                                   ; $03CFEC |
...
CODE_03D040:
  ...
  LDX #$09                                  ; $03D048 |
  LDA #$9B23                                ; $03D04A |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03D04D | GSU init
  LDA $6000                                 ; $03D051 |
...
CODE_03D942:
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03D967 |
  LDX #$00                                  ; $03D96B |
...
CODE_03DAF3:
  ...
  LDX #$09                                  ; $03DB12 |
  LDA #$91D5                                ; $03DB14 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03DB17 | GSU init
  LDX $12                                   ; $03DB1B |
  REP #$10                                  ; $03DB1D |
  LDA !gsu_r6                               ; $03DB1F |
  CMP #$0003                                ; $03DB22 |
...
CODE_03DC04:
  ...
  LDX #$0A                                  ; $03DC09 |
  LDA #$CE2F                                ; $03DC0B |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03DC0E | GSU init
  LDA !gsu_r6                               ; $03DC12 |
  CMP #$0010                                ; $03DC15 |
...
CODE_03DE9C:
  ...
  LDX #$09                                  ; $03DEBB |
  LDA #$91DB                                ; $03DEBD |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03DEC0 | GSU init
  LDA !gsu_r6                               ; $03DEC4 |
  CMP #$0004                                ; $03DEC7 |
...
CODE_03DF4B:
  ...
  LDX #$09                                  ; $03DF5A |
  LDA #$91DB                                ; $03DF5C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03DF5F | GSU init
  LDA !gsu_r6                               ; $03DF63 |
  PHA                                       ; $03DF66 |
  LDA #$017F                                ; $03DF67 |
  STA !gsu_r4                               ; $03DF6A |
  ...
  LDX #$09                                  ; $03DF73 |
  LDA #$91DB                                ; $03DF75 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03DF78 | GSU init
  PLA                                       ; $03DF7C |
  CLC                                       ; $03DF7D |
  ADC !gsu_r6                               ; $03DF7E |
  CMP #$0004                                ; $03DF81 |
  ...
  LDX #$0A                                  ; $03DFB7 |
  LDA #$CE2F                                ; $03DFB9 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $03DFBC | GSU init
  LDA !gsu_r7                               ; $03DFC0 |
  BIT #$0002                                ; $03DFC3 |
...
CODE_03E01F:
  ...
  LDX #$09                                  ; $03E02E |
  LDA #$91DB                                ; $03E030 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03E033 | GSU init
  LDA !gsu_r6                               ; $03E037 |
  PHA                                       ; $03E03A |
  LDA #$017F                                ; $03E03B |
  STA !gsu_r4                               ; $03E03E |
  ...
  LDX #$09                                  ; $03E047 |
  LDA #$91DB                                ; $03E049 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03E04C | GSU init
  PLA                                       ; $03E050 |
  CLC                                       ; $03E051 |
  ADC !gsu_r6                               ; $03E052 |
  CMP #$0004                                ; $03E055 |
...
CODE_03E219:
  LDX #$09                                  ; $03E219 |
  LDA #$91D5                                ; $03E21B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03E21E | GSU init
  LDA #$0008                                ; $03E222 |
  SEC                                       ; $03E225 |
  SBC !gsu_r6                               ; $03E226 |
  CMP #$0005                                ; $03E229 |
...
CODE_03E231:
  ...
  LDX #$09                                  ; $03E23D |
  LDA #$91DB                                ; $03E23F |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03E242 | GSU init
  LDY !gsu_r6                               ; $03E246 |
  CPY $00                                   ; $03E249 |
...
CODE_03E730:
  ...
  LDX #$08                                  ; $03E753 |
  LDA #$8205                                ; $03E755 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03E758 | GSU init
  INC $0CF9                                 ; $03E75C |
  LDX $12                                   ; $03E75F |
...
CODE_03E762:
  ...
  LDX #$08                                  ; $03E783 |
  LDA #$E167                                ; $03E785 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03E788 | GSU init
  LDX $12                                   ; $03E78C |
  RTS                                       ; $03E78E |
...
CODE_03E9FD:
  ...
  LDX #$09                                  ; $03EA1B |
  LDA #$907C                                ; $03EA1D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03EA20 | GSU init
  LDX $12                                   ; $03EA24 |
  LDA !gsu_r1                               ; $03EA26 |
  EOR #$FFFF                                ; $03EA29 |
  INC A                                     ; $03EA2C |
...
CODE_03EC11:
  ...
  LDX #$08                                  ; $03EC82 |
  LDA #$8205                                ; $03EC84 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03EC87 | GSU init
  INC $0CF9                                 ; $03EC8B |
  LDX $12                                   ; $03EC8E |
...
CODE_03EDAB:
  ...
  LDX #$09                                  ; $03EDC9 |
  LDA #$907C                                ; $03EDCB |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03EDCE | GSU init
  LDX $12                                   ; $03EDD2 |
  LDA !gsu_r1                               ; $03EDD4 |
...
; $ED27 table address
  ...
  LDX #$09                                  ; $03F0E4 |
  LDA #$AEC1                                ; $03F0E6 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03F0E9 | GSU init
  LDX $12                                   ; $03F0ED |
...
CODE_03F183:
  ...
  LDX #$09                                  ; $03F198 |
  LDA #$AEC1                                ; $03F19A |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $03F19D | GSU init
  LDX $12                                   ; $03F1A1 |
...
CODE_03F6B1:
  JSL CODE_039F2B                           ; $03F6B1 | entry point
