...
CODE_118050:
  ...
  LDX #$08                                  ; $118085 |
  LDA #$B1EF                                ; $118087 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11808A | GSU init
  LDA $03A7                                 ; $11808E |
  LSR A                                     ; $118091 |
  CLC                                       ; $118092 |
  ADC #$0120                                ; $118093 |
...
CODE_1182AD:
  ...
  LDX #$08                                  ; $1182AF |
  LDA #$B1EF                                ; $1182B1 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $1182B4 | GSU init
  SEP #$20                                  ; $1182B8 |
  RTS                                       ; $1182BA |
...
CODE_118D8D:
  ...
  LDX #$0B                                  ; $118DAF |
  LDA #$C6C5                                ; $118DB1 |
  JSL rom_to_wram_rt($7E,gsu_init_4)        ; $118DB4 | GSU init
  SEP #$20                                  ; $118DB8 |
  RTS                                       ; $118DBA |
...
CODE_119134:
  ...
  LDX #$08                                  ; $11915A |
  LDA #$8945                                ; $11915C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11915F | GSU init
  INC $0CF9                                 ; $119163 |
  SEP #$30                                  ; $119166 |
...
CODE_119178:
  ...
  LDX #$08                                  ; $119198 |
  LDA #$A980                                ; $11919A |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11919D | GSU init
  REP #$30                                  ; $1191A1 |
  LDX #$4E00                                ; $1191A3 |
  LDA #$0070                                ; $1191A6 |
  STA $01                                   ; $1191A9 |
...
CODE_119F05:
  ...
  LDX #$08                                  ; $119F07 |
  LDA #$B1EF                                ; $119F09 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $119F0C | GSU init
  SEP #$20                                  ; $119F10 |
  RTS                                       ; $119F12 |
...
CODE_11A008:
  ...
  LDX #$08                                  ; $11A034 |
  LDA #$84A5                                ; $11A036 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11A039 | GSU init
  INC $0CF9                                 ; $11A03D |
  RTS                                       ; $11A040 |
...
CODE_11A05F:
  ...
  LDX #$08                                  ; $11A07D |
  LDA #$84A5                                ; $11A07F |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11A082 | GSU init
  INC $0CF9                                 ; $11A086 |
...
CODE_11ADF0:
  ...
  LDX #$08                                  ; $11AE33 |
  LDA #$B1EF                                ; $11AE35 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11AE38 | GSU init
  SEP #$20                                  ; $11AE3C |
  RTS                                       ; $11AE3E |
...
init_coin_cannon:
  ...
  LDX #$08                                  ; $11B0EC |
  LDA #$84A5                                ; $11B0EE |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11B0F1 | GSU init
  INC $0CF9                                 ; $11B0F5 |
  LDX $12                                   ; $11B0F8 |
...
CODE_11B39A:
  ...
  LDX #$09                                  ; $11B3A1 |
  LDA #$8DDA                                ; $11B3A3 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11B3A6 | GSU init
  LDX $12                                   ; $11B3AA |
  LDA !gsu_r1                               ; $11B3AC |
...
CODE_11B3D7:
  ...
  LDX #$09                                  ; $11B3F0 |
  LDA #$907C                                ; $11B3F2 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11B3F5 | GSU init
  LDX $12                                   ; $11B3F9 |
  LDY #$02                                  ; $11B3FB |
  LDA !gsu_r1                               ; $11B3FD |
...
CODE_11B407:
  ...
  LDX #$09                                  ; $11B437 |
  LDA #$907C                                ; $11B439 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11B43C | GSU init
  LDX $12                                   ; $11B440 |
  LDA !gsu_r1                               ; $11B442 |
...
CODE_11B502:
  ...
  LDX #$09                                  ; $11B51D |
  LDA #$907C                                ; $11B51F |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11B522 | GSU init
  LDX $12                                   ; $11B526 |
  LDA !gsu_r1                               ; $11B528 |
...
CODE_11B6DB:
  ...
  LDX #$08                                  ; $11B87A |
  LDA #$B1EF                                ; $11B87C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11B87F | GSU init
  SEP #$20                                  ; $11B883 |
  RTS                                       ; $11B885 |
...
CODE_11BB1E:
  ...
  LDX #$0A                                  ; $11BB31 |
  LDA #$CE2F                                ; $11BB33 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11BB36 | GSU init
  LDX $12                                   ; $11BB3A |
  REP #$10                                  ; $11BB3C |
  LDA #$0010                                ; $11BB3E |
  STA $00                                   ; $11BB41 |
...
CODE_11BCFE:
  ...
  LDX #$09                                  ; $11BD02 |
  LDA #$8DDA                                ; $11BD04 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11BD07 | GSU init
  LDX $12                                   ; $11BD0B |
  LDA !gsu_r1                               ; $11BD0D |
  ...
  LDX #$09                                  ; $11BD39 |
  LDA #$907C                                ; $11BD3B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11BD3E | GSU init
  LDX $12                                   ; $11BD42 |
  LDA !gsu_r2                               ; $11BD44 |
...
CODE_11BDEE:
  ...
  LDX #$09                                  ; $11BDF2 |
  LDA #$8DDA                                ; $11BDF4 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11BDF7 | GSU init
  LDX $12                                   ; $11BDFB |
  LDA !gsu_r1                               ; $11BDFD |
...
CODE_11BE89:
  ...
  LDX #$0A                                  ; $11BEA0 |
  LDA #$CE2F                                ; $11BEA2 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11BEA5 | GSU init
  LDX $12                                   ; $11BEA9 |
  LDY #$02                                  ; $11BEAB |
  LDA !gsu_r5                               ; $11BEAD |
...
CODE_11BED0:
  ...
  LDX #$09                                  ; $11BEF0 |
  LDA #$907C                                ; $11BEF2 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11BEF5 | GSU init
  LDX $12                                   ; $11BEF9 |
  LDY #$02                                  ; $11BEFB |
  LDA !gsu_r1                               ; $11BEFD |
...
CODE_11BF46:
  ...
  LDX #$0A                                  ; $11BF72 |
  LDA #$CE2F                                ; $11BF74 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11BF77 | GSU init
  LDX $12                                   ; $11BF7B |
  LDA !gsu_r5                               ; $11BF7D |
...
CODE_11BF9D:
  ...
  LDX #$0A                                  ; $11BFC0 |
  LDA #$CE2F                                ; $11BFC2 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11BFC5 | GSU init
  LDX $12                                   ; $11BFC9 |
  LDA !gsu_r5                               ; $11BFCB |
...
CODE_11C09C:
  ...
  LDX #$0A                                  ; $11C0B6 |
  LDA #$CE2F                                ; $11C0B8 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C0BB | GSU init
  LDX $12                                   ; $11C0BF |
  LDA !gsu_r5                               ; $11C0C1 |
...
CODE_11C122:
  ...
  LDX #$0A                                  ; $11C13A |
  LDA #$CE2F                                ; $11C13C |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C13F | GSU init
  LDX $12                                   ; $11C143 |
  LDA !gsu_r5                               ; $11C145 |
  ...
  LDX #$0A                                  ; $11C158 |
  LDA #$CE2F                                ; $11C15A |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C15D | GSU init
  LDX $12                                   ; $11C161 |
  LDA !gsu_r7                               ; $11C163 |
  AND #$0001                                ; $11C166 |
  ...
  LDX #$0A                                  ; $11C179 |
  LDA #$CE2F                                ; $11C17B |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C17E | GSU init
  LDX $12                                   ; $11C182 |
  LDA !gsu_r7                               ; $11C184 |
  AND #$0001                                ; $11C187 |
...
CODE_11C19D:
  ...
  LDX #$0A                                  ; $11C1B4 |
  LDA #$CE2F                                ; $11C1B6 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C1B9 | GSU init
  LDX $12                                   ; $11C1BD |
  LDA !gsu_r5                               ; $11C1BF |
...
CODE_11C1E8:
  ...
  LDX #$0A                                  ; $11C202 |
  LDA #$CE2F                                ; $11C204 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C207 | GSU init
  LDX $12                                   ; $11C20B |
  LDA !gsu_r5                               ; $11C20D |
...
CODE_11C371:
  ...
  LDX #$0A                                  ; $11C3BF |
  LDA #$CE2F                                ; $11C3C1 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $11C3C4 | GSU init
  LDX $12                                   ; $11C3C8 |
  LDA !gsu_r5                               ; $11C3CA |
...
CODE_11C632:
  ...
  LDX #$08                                  ; $11C634 |
  LDA #$B1EF                                ; $11C636 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11C639 | GSU init
  SEP #$20                                  ; $11C63D |
  RTS                                       ; $11C63F |
...
CODE_11C905:
  ...
  LDX #$08                                  ; $11C946 |
  LDA #$9BE1                                ; $11C948 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11C94B | GSU init
  INC $0CF9                                 ; $11C94F |
  ...
  LDX #$08                                  ; $11C98F |
  LDA #$9BC5                                ; $11C991 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $11C994 | GSU init
  INC $0CF9                                 ; $11C998 |
  LDX $12                                   ; $11C99B |
