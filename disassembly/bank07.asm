...
CODE_07815C:
  ...
  LDX #$09                                  ; $078181 |
  LDA #$91D5                                ; $078183 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $078186 | GSU init
  LDX $12                                   ; $07818A |
  LDA !gsu_r6                               ; $07818C |
  CMP #$0006                                ; $07818F |
...
CODE_07828F:
  ...
  LDX #$09                                  ; $078299 |
  LDA #$91D5                                ; $07829B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07829E | GSU init
  LDX $12                                   ; $0782A2 |
  LDA !gsu_r6                               ; $0782A4 |
  CMP #$0006                                ; $0782A7 |
  ...
  LDX #$09                                  ; $0782BA |
  LDA #$91DB                                ; $0782BC |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0782BF | GSU init
  LDX $12                                   ; $0782C3 |
  LDA !gsu_r6                               ; $0782C5 |
  CLC                                       ; $0782C8 |
  ADC $00                                   ; $0782C9 |
...
CODE_078425:
  ...
  LDX #$09                                  ; $078443 |
  LDA #$933A                                ; $078445 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $078448 | GSU init
  LDX $12                                   ; $07844C |
  LDY !gsu_r1                               ; $07844E |
...
CODE_078CF1:
  ...
  LDX #$09                                  ; $078CF6 |
  LDA #$8F33                                ; $078CF8 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $078CFB | GSU init
  PLX                                       ; $078CFF |
  LDY !gsu_r1                               ; $078D00 |
...
CODE_078F2F:
  ...
  LDX #$09                                  ; $078F36 |
  LDA #$8EBF                                ; $078F38 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $078F3B | GSU init
  LDX $12                                   ; $078F3F |
  LDY !gsu_r1                               ; $078F41 |
...
CODE_078FD4:
  ...
  LDX #$09                                  ; $078FDB |
  LDA #$8EBF                                ; $078FDD |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $078FE0 | GSU init
  LDX $12                                   ; $078FE4 |
  LDY !gsu_r1                               ; $078FE6 |
...
CODE_0792B9:
  ...
  LDX #$09                                  ; $0792BE |
  LDA #$8F33                                ; $0792C0 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0792C3 | GSU init
  PLX                                       ; $0792C7 |
  LDY !gsu_r1                               ; $0792C8 |
...
CODE_079AB5:
  ...
  LDX #$09                                  ; $079ABC |
  LDA #$8F33                                ; $079ABE |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $079AC1 | GSU init
  LDX $12                                   ; $079AC5 |
...
CODE_079B88:
  ...
  LDX #$09                                  ; $079B8C |
  LDA #$8F33                                ; $079B8E |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $079B91 | GSU init
  LDX $12                                   ; $079B95 |
...
CODE_079CC9:
  ...
  LDX #$09                                  ; $079CCD |
  LDA #$9011                                ; $079CCF |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $079CD2 | GSU init
...
CODE_079CF7:
  LDX #$09                                  ; $079CF7 |
  LDA !gsu_r15                              ; $079CF9 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $079CFC | GSU init
...
CODE_07A3EF:
  ...
  LDX #$09                                  ; $07A413 |
  LDA #$907C                                ; $07A415 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07A418 | GSU init
  LDX $12                                   ; $07A41C |
...
CODE_07AA8D:
  ...
  LDX #$09                                  ; $07AAB4 |
  LDA #$907C                                ; $07AAB6 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07AAB9 | GSU init
  LDX $12                                   ; $07AABD |
  LDA #$011D                                ; $07AABF |
...
init_fat_guy:
  ...
  LDX #$09                                  ; $07ADE8 |
  LDA #$91DB                                ; $07ADEA |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07ADED | GSU init
  LDX $12                                   ; $07ADF1 |
  LDA !gsu_r6                               ; $07ADF3 |
  CMP #$0003                                ; $07ADF6 |
...
CODE_07BDA7:
  ...
  LDX #$09                                  ; $07BDCE |
  LDA #$907C                                ; $07BDD0 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07BDD3 | GSU init
  LDX $12                                   ; $07BDD7 |
  LDA !gsu_r1                               ; $07BDD9 |
...
main_spray_fish:
  ...
  LDX #$08                                  ; $07BF18 |
  LDA #$9332                                ; $07BF1A |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07BF1D | GSU init
  LDX $12                                   ; $07BF21 |
...
CODE_07C192:
  ...
  LDX #$A908                                ; $07C1A3 |
  ROL $94,x                                 ; $07C1A6 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07C1A8 | GSU init
  LDX $12                                   ; $07C1AC |
  LDA !gsu_r11                              ; $07C1AE |
...
CODE_07C632:
  ...
  LDX #$09                                  ; $07C659 |
  LDA #$907C                                ; $07C65B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07C65E | GSU init
  LDX $12                                   ; $07C662 |
  LDA #$011D                                ; $07C664 |
...
CODE_07CF00:
  ...
  LDX #$09                                  ; $07CF10 |
  LDA #$8F33                                ; $07CF12 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07CF15 | GSU init
  LDX $12                                   ; $07CF19 |
  LDA !gsu_r1                               ; $07CF1B |
...
CODE_07D550:
  ...
  LDX #$0A                                  ; $07D565 |
  LDA #$CE2F                                ; $07D567 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $07D56A | GSU init
  LDX $12                                   ; $07D56E |
  LDA !gsu_r7                               ; $07D570 |
  AND #$F800                                ; $07D573 |
  CMP #$4000                                ; $07D576 |
  ...
  LDX #$0A                                  ; $07D58A |
  LDA #$CE2F                                ; $07D58C |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $07D58F | GSU init
  LDX $12                                   ; $07D593 |
  LDA !gsu_r7                               ; $07D595 |
  AND #$F800                                ; $07D598 |
  CMP #$4000                                ; $07D59B |
...
CODE_07D701:
  ...
  LDX #$0A                                  ; $07D718 |
  LDA #$CE2F                                ; $07D71A |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $07D71D | GSU init
  LDX $12                                   ; $07D721 |
  LDA !gsu_r7                               ; $07D723 |
  AND #$F800                                ; $07D726 |
  CMP #$4000                                ; $07D729 |
...
CODE_07D731:
  ...
  LDX #$0A                                  ; $07D742 |
  LDA #$CE2F                                ; $07D744 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $07D747 | GSU init
  LDX $12                                   ; $07D74B |
  LDA !gsu_r7                               ; $07D74D |
  AND #$F800                                ; $07D750 |
  CMP #$4000                                ; $07D753 |
...
main_beach_koopa:
  LDX #$08                                  ; $07DDA1 |
  LDA #$949D                                ; $07DDA3 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07DDA6 | GSU init
  LDX $12                                   ; $07DDAA |
...
CODE_07DDE4:
  LDX #$08                                  ; $07DDE4 |
  LDA #$949D                                ; $07DDE6 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07DDE9 | GSU init
  LDX $12                                   ; $07DDED |
...
CODE_07DE89:
  ...
  LDX #$09                                  ; $07DE9A |
  LDA #$9856                                ; $07DE9C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07DE9F | GSU init
  LDX $12                                   ; $07DEA3 |
  LDY !gsu_r9                               ; $07DEA5 |
...
CODE_07E399:
  ...
  LDX #$08                                  ; $07E3A1 |
  LDA #$949D                                ; $07E3A3 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E3A6 | GSU init
  LDX $12                                   ; $07E3AA |
...
CODE_07E3BD:
  LDX #$08                                  ; $07E3BD |
  LDA #$949D                                ; $07E3BF |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E3C2 | GSU init
  LDX $12                                   ; $07E3C6 |
...
CODE_07E3DF:
  ...
  LDX #$08                                  ; $07E3E4 |
  LDA #$949D                                ; $07E3E6 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E3E9 | GSU init
  LDX $12                                   ; $07E3ED |
  LDA #$0167                                ; $07E3EF |
  STA $00                                   ; $07E3F2 |
  LDA #$0169                                ; $07E3F4 |
...
CODE_07E3F9:
  ...
  LDX #$08                                  ; $07E3FE |
  LDA #$949D                                ; $07E400 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E403 | GSU init
  LDX $12                                   ; $07E407 |
  LDA #$0168                                ; $07E409 |
  STA $00                                   ; $07E40C |
  LDA #$016A                                ; $07E40E |
...
CODE_07E56A:
  LDX #$08                                  ; $07E56A |
  LDA #$949D                                ; $07E56C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E56F | GSU init
  LDX $12                                   ; $07E573 |
...
CODE_07E5E9:
  LDX #$08                                  ; $07E5E9 |
  LDA #$949D                                ; $07E5EB |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E5EE | GSU init
  LDX $12                                   ; $07E5F2 |
...
CODE_07E65F:
  LDX #$08                                  ; $07E65F |
  LDA #$949D                                ; $07E661 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E664 | GSU init
  LDX $12                                   ; $07E668 |
...
CODE_07E768:
  ...
  LDX #$08                                  ; $07E769 |
  LDA #$949D                                ; $07E76B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07E76E | GSU init
  PLA                                       ; $07E772 |
  LDX $12                                   ; $07E773 |
  TXY                                       ; $07E775 |
...
CODE_07EADE:
  ...
  LDX #$0A                                  ; $07EAFB |
  LDA #$CE2F                                ; $07EAFD |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $07EB00 | GSU init
  LDX $12                                   ; $07EB04 |
  LDA !gsu_r6                               ; $07EB06 |
  CMP #$77C2                                ; $07EB09 |
...
init_bvz_large_spring_ball:
  ...
  LDX #$08                                  ; $07F16A |
  LDA #$8293                                ; $07F16C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F16F | GSU init
  LDX $12                                   ; $07F173 |
  INC $0CF9                                 ; $07F175 |
  LDA #$0008                                ; $07F178 |
...
init_bvz_crate_with_6_stars:
  ...
  LDX #$08                                  ; $07F22C |
  LDA #$8293                                ; $07F22E |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F231 | GSU init
  LDX $12                                   ; $07F235 |
  INC $0CF9                                 ; $07F237 |
  LDA #$0016                                ; $07F23A |
...
main_bvz_enemies:
  ...
  LDX #$08                                  ; $07F2B5 |
  LDA #$95B9                                ; $07F2B7 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F2BA | GSU init
  LDX $12                                   ; $07F2BE |
...
main_bvz_large_spring_ball:
  ...
  LDX #$08                                  ; $07F2D8 |
  LDA #$95B9                                ; $07F2DA |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F2DD | GSU init
  LDX $12                                   ; $07F2E1 |
...
main_bvz_melon_and_giant_egg:
  ...
  LDX #$08                                  ; $07F2F4 |
  LDA #$95B9                                ; $07F2F6 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F2F9 | GSU init
  LDX $12                                   ; $07F2FD |
...
main_bvz_icy_watermelon:
  ...
  LDX #$08                                  ; $07F313 |
  LDA #$95B9                                ; $07F315 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F318 | GSU init
  LDX $12                                   ; $07F31C |
...
main_bvz_consumables:
  ...
  LDX #$08                                  ; $07F33C |
  LDA #$95B9                                ; $07F33E |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F341 | GSU init
  LDX $12                                   ; $07F345 |
...
main_bvz_crate_with_6_stars:
  ...
  LDX #$08                                  ; $07F3AF |
  LDA #$95F4                                ; $07F3B1 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F3B4 | GSU init
  LDX $12                                   ; $07F3B8 |
...
CODE_07F497:
  ...
  LDX #$09                                  ; $07F4A3 |
  LDA #$8F33                                ; $07F4A5 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F4A8 | GSU init
  LDX $12                                   ; $07F4AC |
  LDY !gsu_r1                               ; $07F4AE |
...
CODE_07F5A8:
  ...
  LDX #$09                                  ; $07F5BC |
  LDA #$8F33                                ; $07F5BE |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07F5C1 | GSU init
  LDX $12                                   ; $07F5C5 |
  LDY !gsu_r1                               ; $07F5C7 |
...
main_bvz:
  ...
  LDX #$08                                  ; $07FB40 |
  LDA #$95B9                                ; $07FB42 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $07FB45 | GSU init
  LDX $12                                   ; $07FB49 |
...
CODE_07FEFF:
  ...
  LDX #$0A                                  ; $07FF13 |
  LDA #$CE2F                                ; $07FF15 |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $07FF18 | GSU init
  LDX $12                                   ; $07FF1C |
  LDA !gsu_r6                               ; $07FF1E |
  CMP #$7D24                                ; $07FF21 |
  RTS                                       ; $07FF24 |
