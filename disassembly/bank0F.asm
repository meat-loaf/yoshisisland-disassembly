...
main_GOAL_text:
  ...
  LDX #$09                                  ; $0F8050 |
  LDA #$ACDA                                ; $0F8052 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F8055 | GSU init
  LDX $12                                   ; $0F8059 |
...
main_BONUS:
  ...
  LDX #$09                                  ; $0F818B |
  LDA #$AE83                                ; $0F818D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F8190 | GSU init
  LDX $12                                   ; $0F8194 |
...
CODE_0F8E49:
  ...
  LDX #$08                                  ; $0F8E97 |
  LDA #$8295                                ; $0F8E99 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F8E9C | GSU init
  LDX $12                                   ; $0F8EA0 |
  INC $0CF9                                 ; $0F8EA2 |
...
main_hidden_winged_cloud_A:
  ...
  LDX #$09                                  ; $0F8EF3 |
  LDA #$9011                                ; $0F8EF5 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F8EF8 | GSU init
...
CODE_0F8EFC:
  ...
  LDX #$09                                  ; $0F8F10 |
  LDA !gsu_r15                              ; $0F8F12 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F8F15 | GSU init
...
main_sparrow:
  ...
  LDX #$09                                  ; $0F8F98 |
  LDA #$8F33                                ; $0F8F9A |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F8F9D | GSU init
  LDX $12                                   ; $0F8FA1 |
  LDY !gsu_r1                               ; $0F8FA3 |
...
main_bonus_sprite:
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F92AA | GSU init
  LDX $12                                   ; $0F92AE |
  LDA !gsu_r11                              ; $0F92B0 |\
...
CODE_0F970B:
  ...
  LDX #$09                                  ; $0F9729 |
  LDA #$9253                                ; $0F972B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F972E | GSU init
  LDX $12                                   ; $0F9732 |
...
CODE_0F9838:
  ...
  LDX #$08                                  ; $0F986B |
  LDA #$8295                                ; $0F986D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F9870 | GSU init
  LDX $12                                   ; $0F9874 |
  ...
  LDX #$08                                  ; $0F98AD |
  LDA #$8295                                ; $0F98AF |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F98B2 | GSU init
  INC $0CF9                                 ; $0F98B6 |
  LDX $12                                   ; $0F98B9 |
  RTS                                       ; $0F98BB |
...
CODE_0F9AF7:
  ...
  LDX #$09                                  ; $0F9B34 |
  LDA #$9253                                ; $0F9B36 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F9B39 | GSU init
  LDX $12                                   ; $0F9B3D |
...
CODE_0F9BC9:
  ...
  LDX #$A908                                ; $0F9BFC |
  STA $82,x                                 ; $0F9BFF |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0F9C01 | GSU init
  INC $0CF9                                 ; $0F9C05 |
  LDX $12                                   ; $0F9C08 |
  RTS                                       ; $0F9C0A |
...
CODE_0FA726:
  ...
  LDX #$08                                  ; $0FA74C |
  LDA #$8205                                ; $0FA74E |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FA751 | GSU init
  INC $0CF9                                 ; $0FA755 |
  LDX $12                                   ; $0FA758 |
  RTS                                       ; $0FA75A |
...
CODE_0FA76C:
  ...
  LDX #$08                                  ; $0FA790 |
  LDA #$881C                                ; $0FA792 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FA795 | GSU init
  INC $0CF9                                 ; $0FA799 |
  LDX $12                                   ; $0FA79C |
  RTS                                       ; $0FA79E |
...
CODE_0FA985:
  ...
  LDX #$09                                  ; $0FA98E |
  LDA #$A02A                                ; $0FA990 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FA993 | GSU init
  SEP #$20                                  ; $0FA997 |
  LDX $12                                   ; $0FA999 |
  RTS                                       ; $0FA99B |
...
CODE_0FAD5F:
  ...
  LDX #$08                                  ; $0FAD99 |
  LDA #$8B49                                ; $0FAD9B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FAD9E | GSU init
  INC $0CF9                                 ; $0FADA2 |
  LDX $12                                   ; $0FADA5 |
...
CODE_0FADC4:
  ...
  LDX #$08                                  ; $0FAE03 |
  LDA #$8205                                ; $0FAE05 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FAE08 | GSU init
  INC $0CF9                                 ; $0FAE0C |
  LDX $12                                   ; $0FAE0F |
  RTS                                       ; $0FAE11 |
...
CODE_0FB1E6:
  ...
  LDX #$08                                  ; $0FB20D |
  LDA #$E167                                ; $0FB20F |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FB212 | GSU init
  SEP #$30                                  ; $0FB216 |
  LDX $12                                   ; $0FB218 |
  RTS                                       ; $0FB21A |
...
CODE_0FB881:
  ...
  LDX #$08                                  ; $0FB895 |
  LDA #$E132                                ; $0FB897 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FB89A | GSU init
  LDX $12                                   ; $0FB89E |
  LDA !gsu_r3                               ; $0FB8A0 |
  STA $702DEA                               ; $0FB8A3 |
  STA $70207E                               ; $0FB8A7 |
...
CODE_0FB8AE:
  ...
  LDX #$08                                  ; $0FB8C2 |
  LDA #$E132                                ; $0FB8C4 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FB8C7 | GSU init
  LDX $12                                   ; $0FB8CB |
  LDA !gsu_r3                               ; $0FB8CD |
  STA $702DE8                               ; $0FB8D0 |
  STA $70207C                               ; $0FB8D4 |
...
gm15_retry_screen_cutscene:
  ...
  LDX #$08                                  ; $0FBC74 |
  LDA #$B1EF                                ; $0FBC76 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FBC79 | GSU init
  LDA $0B4C                                 ; $0FBC7D |
...
CODE_0FBEE5:
  ...
  LDX #$08                                  ; $0FBEFE |
  LDA #$9067                                ; $0FBF00 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FBF03 | GSU init

CODE_0FBF07:
  LDX #$08                                  ; $0FBF07 |
  LDA #$B1EF                                ; $0FBF09 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FBF0C | GSU init
  SEP #$20                                  ; $0FBF10 |
...
CODE_0FBF39:
  ...
  LDX #$09                                  ; $0FBF45 |
  LDA #$884C                                ; $0FBF47 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FBF4A | GSU init
  LDX #$5C                                  ; $0FBF4E |
...
CODE_0FC2FB:
  ...
  LDX #$08                                  ; $0FC300 |
  LDA #$B4A9                                ; $0FC302 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FC305 | GSU init
...
CODE_0FC9E2:
  ...
  LDX #$08                                  ; $0FC9EB |
  LDA #$9004                                ; $0FC9ED |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FC9F0 | GSU init
  LDA #$2000                                ; $0FC9F4 |
  STA $0CF9                                 ; $0FC9F7 |
  LDX $12                                   ; $0FC9FA |
  LDY #$62                                  ; $0FC9FC |
...
CODE_0FCB3D:
  ...
  LDX #$08                                  ; $0FCB70 |
  LDA #$9083                                ; $0FCB72 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FCB75 | GSU init
  REP #$10                                  ; $0FCB79 |
...
CODE_0FCCF5:
  ...
  LDX #$09                                  ; $0FCD21 |
  LDA #$E9AF                                ; $0FCD23 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FCD26 | GSU init
  SEP #$20                                  ; $0FCD2A |
  PLA                                       ; $0FCD2C |
  STA $012E                                 ; $0FCD2D |
  PLA                                       ; $0FCD30 |
...
CODE_0FD965:
  ...
  LDX #$08                                  ; $0FD9A8 |
  LDA #$8295                                ; $0FD9AA |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FD9AD | GSU init
  LDA #$0800                                ; $0FD9B1 |
  STA $0CF9                                 ; $0FD9B4 |
  LDX $12                                   ; $0FD9B7 |
  RTS                                       ; $0FD9B9 |
...
CODE_0FDAF0:
  ...
  LDX #$0B                                  ; $0FDB0B |
  LDA #$86B6                                ; $0FDB0D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FDB10 | GSU init
  LDX $12                                   ; $0FDB14 |
...
CODE_0FDB2F:
  ...
  LDX #$08                                  ; $0FDB7A |
  LDA #$8295                                ; $0FDB7C |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FDB7F | GSU init
  LDA #$0800                                ; $0FDB83 |
  STA $0CF9                                 ; $0FDB86 |
  LDX $12                                   ; $0FDB89 |
...
CODE_0FDD69:
  ...
  LDX #$08                                  ; $0FDD99 |
  LDA #$84A5                                ; $0FDD9B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FDD9E | GSU init
  LDX $12                                   ; $0FDDA2 |
  LDA #$0800                                ; $0FDDA4 |
  STA $0CF9                                 ; $0FDDA7 |
  RTS                                       ; $0FDDAA |
...
CODE_0FDE89:
  ...
  LDX #$0B                                  ; $0FDEA0 |
  LDA #$BCF8                                ; $0FDEA2 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0FDEA5 | GSU init
  LDX $12                                   ; $0FDEA9 |
  LDA !gsu_r1                               ; $0FDEAB |
  SEP #$20                                  ; $0FDEAE |
  EOR #$FF                                  ; $0FDEB0 |
