...
CODE_018066:
  ...
  LDX #$08                                  ; $01808B |
  LDA #$AA7F                                ; $01808D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $018090 | GSU
  LDA #$7FFF                                ; $018094 |
  STA $702F8C                               ; $018097 |
  LDX #$1C                                  ; $01809B |
...
CODE_0180B9:
  ...
  LDX #$08                                  ; $0180E5 |
  LDA #$9208                                ; $0180E7 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0180EA | GSU
...
CODE_018113:
  ...
  LDX #$08                                  ; $018121 |
  LDA #$B4A9                                ; $018123 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $018126 | GSU init
  LDA $702020                               ; $01812A |
...
CODE_018A60:
  ...
  LDX #$08                                  ; $018A71 |
  LDA #$A000                                ; $018A73 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $018A76 | GSU init
  LDA !gsu_r3                               ; $018A7A |
...
CODE_018AF5:
  ...
  LDX #$08                                  ; $018B0B |
  LDA #$84A5                                ; $018B0D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $018B10 | gsu drawing routine
  RTS                                       ; $018B14 |
...
CODE_018B15:
  ...
  LDX #$08                                  ; $018B3C |
  LDA #$855F                                ; $018B3E |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $018B41 | gsu drawing routine
  RTS                                       ; $018B45 |
...
CODE_018D1C:
  ...
  LDX #$08                                  ; $018DBE |
  LDA #$A3BA                                ; $018DC0 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $018DC3 | GSU init
  LDX $12                                   ; $018DC7 |
  LDA $6026                                 ; $018DC9 |
  STA $106A                                 ; $018DCC |
  LDA $6028                                 ; $018DCF |
...
CODE_018FE3:
  ...
  LDX #$0B                                  ; $019006 |
  LDA #$8595                                ; $019008 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01900B | GSU init
  LDX $12                                   ; $01900F |
  LDA !gsu_r0                               ; $019011 |
...
CODE_01901D:
  ...
  LDX #$09                                  ; $01903E |
  LDA #$91D5                                ; $019040 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019043 | GSU init
  LDX $12                                   ; $019047 |
  LDY !gsu_r6                               ; $019049 |
  CPY #$06                                  ; $01904C |
...
CODE_01909B:
  ...
  LDX #$09                                  ; $0190C6 |
  LDA #$9011                                ; $0190C8 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0190CB | GSU init
  BRA CODE_0190DA                           ; $0190CF |

CODE_0190D1:
  LDX #$09                                  ; $0190D1 |
  LDA !gsu_r15                              ; $0190D3 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0190D6 | GSU init
...
CODE_0191BB:
  ...
  LDX #$09                                  ; $0191BF |
  LDA #$9011                                ; $0191C1 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0191C4 | GSU init
  BRA CODE_0191D3                           ; $0191C8 |

CODE_0191CA:
  LDX #$09                                  ; $0191CA |
  LDA !gsu_r15                              ; $0191CC |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $0191CF | gsu : picking up where left off?
...
CODE_01960A:
  ...
  LDX #$0B                                  ; $019610 |
  LDA #$86B6                                ; $019612 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019615 | GSU init
  LDA !gsu_r1                               ; $019619 |
  STA !gsu_r6                               ; $01961C |
  LDA !gsu_r0                               ; $01961F |
  SEC                                       ; $019622 |
  ...
  LDX #$0B                                  ; $019629 |
  LDA #$86B6                                ; $01962B |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01962E | GSU init
  LDX $12                                   ; $019632 |
  LDA !gsu_r0                               ; $019634 |
...
CODE_019A64:
  ...
  LDX #$08                                  ; $019A80 |
  LDA #$A929                                ; $019A82 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019A85 | GSU init
  LDX $12                                   ; $019A89 |
  LDA !gsu_r1                               ; $019A8B |
  STA $1088                                 ; $019A8E |
...
CODE_019C23:
  ...
  LDX #$0B                                  ; $019C3B |
  LDA #$86B6                                ; $019C3D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019C40 | GSU init
  LDX $12                                   ; $019C44 |
  LDA !gsu_r0                               ; $019C46 |
...
CODE_019CAB:
  ...
  LDX #$0B                                  ; $019CB7 |
  LDA #$86B6                                ; $019CB9 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019CBC | GSU init
  LDX $12                                   ; $019CC0 |
  LDA !gsu_r0                               ; $019CC2 |
...
CODE_019D2D:
  ...
  LDX #$08                                  ; $019D51 |
  LDA #$AA5F                                ; $019D53 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019D56 | GSU init
  REP #$10                                  ; $019D5A |
  PLA                                       ; $019D5C |
  ASL A                                     ; $019D5D |
  STA $0C16                                 ; $019D5E |
...
CODE_019FC0:
  ...
  LDX #$0B                                  ; $019FCF |
  LDA #$86B6                                ; $019FD1 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $019FD4 | GSU init
  LDX $12                                   ; $019FD8 |
  LDA !gsu_r0                               ; $019FDA |
  SEC                                       ; $019FDD |
  SBC #$0008                                ; $019FDE |
...
CODE_01A0CB:
  ...
  LDX #$0B                                  ; $01A0E8 |
  LDA #$86B6                                ; $01A0EA |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01A0ED | GSU init
  LDX $12                                   ; $01A0F1 |
  LDA !gsu_r0                               ; $01A0F3 |
  SEC                                       ; $01A0F6 |
  SBC #$0008                                ; $01A0F7 |
...
CODE_01A0FE:
  ...
  LDX #$08                                  ; $01A12E |
  LDA #$8293                                ; $01A130 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01A133 | GSU init
  INC $0CF9                                 ; $01A137 |
  LDX $12                                   ; $01A13A |
  LDA #$6E6C                                ; $01A13C |
...
CODE_01A62D:
  ...
  LDX #$09                                  ; $01A636 |
  LDA #$9011                                ; $01A638 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01A63B | GSU init
...
CODE_01A63F:
  ...
  LDX #$09                                  ; $01A695 |
  LDA !gsu_r15                              ; $01A697 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01A69A | gsu (continue from previous?)
...
CODE_01A93D:
  ...
  LDX #$0A                                  ; $01A97B |
  LDA #$CE2F                                ; $01A97D |
  JSL rom_to_wram_rt($7E,gsu_init_3)        ; $01A980 | GSU init
  LDX $12                                   ; $01A984 |
  PLY                                       ; $01A986 |
  LDA !gsu_r6                               ; $01A987 |
  CMP #$0000                                ; $01A98A |
...
CODE_01AB13:
  ...
  LDX #$08                                  ; $01AB53 |
  LDA #$D964                                ; $01AB55 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01AB58 | GSU init
  LDX $12                                   ; $01AB5C |
  INC $0CF9                                 ; $01AB5E |
...
gm0d_level_fadein_post_pipe_or_door:
  ...
  LDX #$08                                  ; $01B4FF |
  LDA #$8E48                                ; $01B501 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01B504 | GSU init
  LDA $0B4C                                 ; $01B508 |
  CLC                                       ; $01B50B |
  ADC #$0008                                ; $01B50C |
  STA $0B4C                                 ; $01B50F |
...
CODE_01C29D:
  LDX #$08                                  ; $01C29D |
  LDA #$B1EF                                ; $01C29F |
  JSL rom_to_wram_rt($7E,gsu_init_2)        ; $01C2A2 | copy OAM buffer
...
CODE_01CD56:
  ...
  LDX #$08                                  ; $01CD64 |
  LDA #$D2F1                                ; $01CD66 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01CD69 | GSU init
  LDX #$04                                  ; $01CD6D |
...
CODE_01CD6F:
  ...
  LDX #$08                                  ; $01CDA0 |
  LDA #$F165                                ; $01CDA2 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01CDA5 | GSU init
  PLX                                       ; $01CDA9 |
  DEX                                       ; $01CDAA |
  ...
  LDX #$08                                  ; $01CDC5 |
  LDA #$D2FB                                ; $01CDC7 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01CDCA | GSU init
  LDA #$7600                                ; $01CDCE |
  STA !gsu_r1                               ; $01CDD1 |
  LDA #$7300                                ; $01CDD4 |
  STA !gsu_r2                               ; $01CDD7 |
  ...
  LDX #$08                                  ; $01CDE6 |
  LDA #$D2FB                                ; $01CDE8 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01CDEB | GSU init
  LDA #$AAAA                                ; $01CDEF |
  STA $006C00                               ; $01CDF2 |
  STA $006C02                               ; $01CDF6 |
  STA $006C04                               ; $01CDFA |
...
.prepare_tables
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D645 |/  $0890E7
  LDA #$56DE                                ; $01D649 |\
  STA $20                                   ; $01D64C | |
...
CODE_01D6E5:
  ...
  LDX #$08                                  ; $01D6ED |
  LDA #$BE12                                ; $01D6EF |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D6F2 | GSU init
  LDA !gsu_r1                               ; $01D6F6 |
  SEC                                       ; $01D6F9 |
  SBC #$385E                                ; $01D6FA |
...
CODE_01D795:
  ...
  LDX #$08                                  ; $01D7AF |
  LDA #$DC26                                ; $01D7B1 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D7B4 | GSU init
  LDA #$01A4                                ; $01D7B8 |
...
CODE_01D7CD:
  ...
  LDX #$08                                  ; $01D7FF |
  LDA #$DD23                                ; $01D801 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D804 | GSU init
  LDA #$01A4                                ; $01D808 |
...
CODE_01D81D:
  ...
  LDX #$08                                  ; $01D84F |
  LDA #$DC4D                                ; $01D851 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D854 | GSU init
  LDA #$01A4                                ; $01D858 |
...
CODE_01D86D:
  ...
  LDX #$08                                  ; $01D89F |
  LDA #$DC4D                                ; $01D8A1 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D8A4 | GSU init
  LDA #$01A4                                ; $01D8A8 |
...
CODE_01D8C6:
  ...
  LDX #$08                                  ; $01D8F8 |
  LDA #$DD23                                ; $01D8FA |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01D8FD | GSU init
  LDA #$01A4                                ; $01D901 |
...
.morph_tint
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01DA3C |/  the two colors
...
.compute_BG1
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01DA62 |/  ($701EF2~$701F71)
  SEP #$20                                  ; $01DA66 |
  RTS                                       ; $01DA68 |
...
.compute_OPT_offsets
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01DA91 |
  SEP #$20                                  ; $01DA95 |
  RTS                                       ; $01DA97 |
...
.call_gsu
  ...
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01DABC |
  SEP #$20                                  ; $01DAC0 |
  RTS                                       ; $01DAC2 |
...
CODE_01E08D:
  LDX #$08                                  ; $01E08D |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01E08F | GSU init
  SEP #$20                                  ; $01E093 |
  LDA $10                                   ; $01E095 |
...
CODE_01E1D6:
  LDX #$09                                  ; $01E1D6 |
  LDA #$B03E                                ; $01E1D8 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01E1DB | GSU init
  SEP #$20                                  ; $01E1DF |
  PLA                                       ; $01E1E1 |
  STA $012E                                 ; $01E1E2 |
  PLA                                       ; $01E1E5 |
...
.setup_special_palette
  ...
  LDX #$08                                  ; $01ED30 |
  LDA #$EBB5                                ; $01ED32 |
  JSL rom_to_wram_rt($7E,gsu_init_1)        ; $01ED35 | GSU init
  LDA #$56DE                                ; $01ED39 |\
  STA $20                                   ; $01ED3C | |
